...
content.addEventListener('click', (e) => {
  ...
  ;}
    ...
    const checkbx=document.querySelectorAll('.checkBox')[1]
    if(!checkbx){console.log('')
    statechange();}
    else{
    checkbx.addEventListener('change', (e) => {
    ...
    clearCompleted.addEventListener('click',(e)=>{
      ...
      const filtered=filt.filter(element=(x)=>{ return x.completed===false});
